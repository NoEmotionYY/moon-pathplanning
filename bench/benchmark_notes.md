...
Dijkstra、PSO、RS-APSO、RS-APSO 参数变体、RRT、RRT-Connect 和 RRT* 的 CSV 指标，并记录 seed、种群大小或采样参数、最大迭代次数、默认 5 次
...
当前 RS-APSO 参数变体包括 `rs_apso_p30_i60_s2` 和 `rs_apso_p80_i80_s4`；算法名中的
`p`、`i`、`s` 分别表示种群规模、最大迭代次数和停滞阈值，用于在不扩展 CSV schema
的情况下比较参数影响。
